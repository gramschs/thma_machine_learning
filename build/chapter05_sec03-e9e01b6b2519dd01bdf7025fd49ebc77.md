...
Die meisten Autos haben weniger als 200 000 km auf dem Kilometerzähler.
...
| --- | --- | --- |
| Wie oft kommt jede Marke vor? | Barplot | `px.bar(data['Marke'].value_counts())` |
| Wie verteilen sich die Kilometerstände? | Histogramm | `px.histogram(data['Kilometerstand (km)'], nbins=10)` |
