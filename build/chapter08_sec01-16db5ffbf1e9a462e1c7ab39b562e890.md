...
* Die fehlenden Werte aus der Spalte »Leistung (kW)« **umrechnen**. Das ist hier
  die beste Lösung, denn »Leistung (PS)« und »Leistung (kW)« sind dasselbe Merkmal
  in zwei Einheiten. Genau genommen ist eine der beiden Spalten überflüssig und
  wir könnten »Leistung (PS)« auch ganz entfernen.
