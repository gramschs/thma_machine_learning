...
druckversuche.head()
```
Der Datensatz enthält 18 Zeilen und 14 Spalten.

zu 3)
```python
druckversuche.info()
```
Die Spalte `Bemerkungen` hat nur 16 von 18 non-null-Einträgen, bei 2
...
```
Die durchschnittliche Zugfestigkeit liegt bei rund 33.7 MPa. Die Druckzeit
reicht von 60 bis 1030 Minuten, die Spannweite beträgt also 970 Minuten.
````
