...
Box? Die Boz zeigt uns die Quantile. Sie wird unten durch das 0.25-Quantil (auch
Q1-Quartile genannt) und oben durch das 0.75-Quantil (auch Q3-Quartil genannt)
...
(englisch Whisker) zeigen den Bereich der übrigen Daten an. Bei unseren Daten
endet die untere Antenne beim billigsten Auto (1999 EUR). Die obere Antenne
endet allerdings bei 35990 EUR und damit *nicht* beim teuersten Auto. Warum das
so ist, klären wir im nächsten Abschnitt.
