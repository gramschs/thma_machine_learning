...
* [ ] Sie berechnen statistische Kennzahlen einer Series mit **mean()**, **std()**, **min()**, **max()** und **describe()**.
* [ ] Sie identifizieren fehlende Werte (**NaN**) mit **isna()** und behandeln sie mit **dropna()** oder **fillna()**.
* [ ] Sie erstellen mit **px.box()** aus Plotly Express einen Boxplot für eine Series.
* [ ] Sie interpretieren die Elemente eines Boxplots (**Median**, **Quartile**, **Whisker**, **Ausreißer**) und ordnen ihnen die entsprechenden statistischen Kennzahlen zu.
* [ ] Sie filtern Ausreißer aus einer Series mithilfe **boolescher Indizierung** heraus.
