...
beiden Parameter $w_0$ und $w_1$, also die Steigung $w_1$ in `.coef_` und den
y-Achsenabschnitt $w_0$ in `.intercept_`.
...
Mit der trainierten linearen Funktion $y = 85.2 \cdot x + 2179$ könnten wir nun
