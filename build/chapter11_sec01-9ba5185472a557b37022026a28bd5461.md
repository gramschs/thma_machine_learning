...
Neuronale Netze sind weit verbreitete Verfahren des maschinellen Lernens. Das
einfachste neuronale Modell besteht aus einem einzelnen künstlichen Neuron, dem
sogenannten Perzeptron. Es kann zur binären Klassifikation verwendet werden und
...
```{figure} pics/fig11_sec01_heaviside_wikipedia.svg
---
...
mit einer reellen Konstante $c$. In der obigen Abbildung ist $c=1$ gewählt.
...
Funktionswert die Heaviside-Funktion an der Stelle $x=0$ hat.
