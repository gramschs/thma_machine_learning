...
Verkaufspreise. Die Datenstruktur **DataFrame** wiederum dient zum Speichern
und Verarbeiten von tabellierten Daten, also Tabellen mit Zeilen und Spalten.

Der entscheidende Unterschied zur Liste ist der **Index**: Bei einer Liste
werden die Elemente ausschließlich über ihre Position 0, 1, 2, ...
...
Series daher als eine Kombination aus Liste und Dictionary vorstellen: Die
Daten haben wie in einer Liste eine feste Reihenfolge und gleichzeitig können
wir wie bei einem Dictionary über Labels auf sie zugreifen. Dazu kommt, dass
eine Series — anders als eine Liste — einen gemeinsamen Datentyp für alle
Elemente erzwingt und dadurch große Datenmengen deutlich effizienter
verarbeiten kann.
...
2. Ein Telefonbuch, in dem zu jedem Namen eine Telefonnummer nachgeschlagen
   wird.
...
2. **Dictionary** — reines Nachschlagen von Schlüssel-Wert-Paaren, Reihenfolge
