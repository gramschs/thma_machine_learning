...
visuell zu erkunden, um Abhängigkeiten zwischen Merkmalen zu erkunden. Wir
könnten beispielsweise auf die Idee kommen, dass der Preis (= potentielle Wirkung) auch
abhängig ist von der Anzahl der gefahrenen Kilometer (= potentielle Ursache). Wir tragen den Kilometerstand auf der x-Achse und den Verkaufspreis auf der y-Achse auf, um zu untersuchen, ob ein Zusammenhang erkennbar ist.
...
ein Auto bereits gefahren wurde, desto günstiger ist sein Verkaufspreis. Allerdings belegt ein sichtbarer Zusammenhang zwischen zwei Merkmalen nicht, dass ein Merkmal ein anderes Merkmal verursacht (Kausalität). Beide Merkmale könnten Wirkung eines anderen Merkmals sein.



Auffällig scheint es zwei Autos zu geben, die nicht ganz in dieses Muster
