...
Ausschnitte eines DataFrames zuzugreifen. Mit den eckigen Klammern **[]** und
dem Spaltennamen wählen wir eine einzelne Spalte als Series aus. Über den
Indexer **.loc[]** greifen wir stattdessen anhand des Zeilenindex auf eine
einzelne Zeile zu, und durch die Kombination aus Zeilen- und Spaltenindex,
getrennt durch ein Komma, sogar auf eine einzelne Zelle. Sollen mehrere Zeilen
oder Spalten gleichzeitig ausgewählt werden, geben wir entweder eine Liste von
Labels an oder nutzen bei zusammenhängenden Bereichen das Slicing mit einem
Doppelpunkt. Schließlich haben wir gesehen, dass sich ein DataFrame über
denselben Mechanismus auch erweitern lässt, indem einer neuen Spalte ein Wert
zugewiesen wird.
