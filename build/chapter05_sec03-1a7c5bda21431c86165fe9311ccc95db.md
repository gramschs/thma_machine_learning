...
mühsam und würde selten auf runde Zahlen führen. Diese Rechnung überlassen wir
daher lieber Plotly.

Um zu ermitteln, wie viele Autos in das jeweilige Intervall fallen, könnten wir
ein kleines Python-Programm schreiben. Tatsächlich brauchen wir das nicht, denn
diese Funktionalität ist bereits in der `histogram()`-Funktion integriert, die
auch die Visualisierung übernimmt.
