...
Für $M$ Beobachtuengen (Datenpunkte) liegen nun jeweils ein Merkmalswert und der
...
Etwas präziser formuliert ist lineare Regression ein Verfahren, bei dem es ein
**Merkmal** $x$ und eine Zielgröße $y$ gibt. In der ML-Sprechweise wird das
Merkmal auch oft als **Feature** bezeichnet. Alle erklärenden Merkmale zusammen
sind dann der **Input**. Die **Zielgröße** (manchmal auch **Output** oder
