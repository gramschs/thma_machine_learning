...
Die Methode `.describe()` aus dem Pandas-Modul (siehe [Pandas-Dokumentation |
...
wenn neue Daten geladen werden, sollte diese Methode direkt am Anfang angewendet
werden. Wir bleiben bei unserem Beispiel mit den zehn Autos und deren
Verkaufspreisen.
...
Die Methode `.describe()` zeigt nicht nur statistische Kennzahlen an, sondern
gibt sie auch als Ergebnis zurück. Dieses Ergebnis können wir in einer Variablen
zwischenspeichern und später weiterverwenden.
