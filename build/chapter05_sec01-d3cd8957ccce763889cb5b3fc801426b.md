...
2. Die Ausgabe zeigt zum Beispiel Material mit 4, Farbe mit 7, Infill-Muster
   ...
   Die restlichen Spalten sind numerisch.
3. Kategoriale Merkmale sind zum Beispiel Material, Farbe, Infill-Muster,
   Oberflaechenguete und Erfolgreich.
4. Nein. Auch wenn Bemerkungen hier zufällig wenige unterschiedliche Werte
   hat, handelt es sich inhaltlich um Freitext-Notizen wie "Nachbearbeitet,
   Stuetzstruktur entfernt". Das ist keine feste, abgeschlossene Menge von
   Kategorien. Die niedrige Kardinalität ist reiner Zufall des kleinen
   Beispieldatensatzes, fachlich bleibt die Spalte Freitext.
````
