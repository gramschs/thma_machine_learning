...
Ein schneller Blick mit `.describe()` zeigt uns, dass der Kilometerstand
zwischen 0 km und 435909 km reicht.

```{code-cell} python
data.describe()
```

Wir möchten nun Autos mit einem sehr großen Kilomterstand ausschließen und
ziehen die Grenze bei 200000 km. Um alle Autos aus dem Datensatz zu filtern,
deren Kilometerstand kleiner als 200000 km ist, benutzen wir den aus der
Mathematik bekannten Kleiner-gleich-Operator `<=` benutzen. Das Ergebnis dieses
