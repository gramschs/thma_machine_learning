...
```{code-cell} python
audis['Marke'].value_count()
```

Diese Bedingung erfüllen 1 190 Autos. Möchten wir mehrere Marken gleichzeitig
auswählen, zum Beispiel Audi, BMW und Mercedes-Benz, müssten wir mit `==` und
`|` (oder) drei Bedingungen einzeln verknüpfen. Kürzer geht das mit der Methode
`.isin()`: Wir übergeben ihr einfach eine Liste der gesuchten Marken.
