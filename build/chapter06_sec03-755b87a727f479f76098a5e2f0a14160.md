...
Genau diese Instabilität, unterschiedliche Bäume je nach Zufallszustand, macht
sich dieses Verfahren zunutze, indem es viele solcher Bäume mittelt. Es heißt
Zufallswald (Random Forest) und wird ausführlich in einem eigenen Kapitel
behandelt werden. In diesem Kapitel betrachten wir nur das Zurechtschneiden der
Entscheidungsbäume.
