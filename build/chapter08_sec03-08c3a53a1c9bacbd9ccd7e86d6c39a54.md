...
`.score()` bewertet, wie gut ein Modell zu den Daten passt. Je näher der Wert an 1
liegt, desto besser. Ein hoher Wert allein sagt aber wenig aus. Ein Modell kann
die Trainingsdaten auswendig lernen und bei neuen Daten trotzdem versagen. Diesen
Fehler nennen wir **Überanpassung**.
...
:class: attention
* [ ] Sie verstehen, warum Daten in **Trainingsdaten** und **Testdaten**
  aufgeteilt werden.
