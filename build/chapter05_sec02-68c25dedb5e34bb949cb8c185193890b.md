...
| Frage | Technik | Beispiel aus dem Kapitel |
|---|---|---|
| Wie viele Audis gibt es? | Filtern | `bedingung_audi = data['Marke'] == 'audi'` |
| Wie hoch ist der Durchschnittspreis je Marke? | Gruppieren | `data.groupby('Marke')['Preis (Euro)'].mean()` |
