...
mehreren Entscheidungbäumen einen kombinierten Entscheidungsbaum zu bilden.
Dieses Verfahren heißt Zufallswald (Random Forest) und wird ausführlich in einem
eigenen Kapitel behandelt werden. In diesem Kapitel betrachten wir nur das
Zurechtschneiden der Entscheidungsbäume.
...
Ein Score von 1.0 auf den Trainingsdaten kann auf Overfitting hindeuten, d.h.
das Modell hat die Daten auswendig gelernt. Ein sehr niedriger Score (z.B. 0.72)
