...
Bei der Qualitätskontrolle im 3D-Druck erfassen wir zu jedem Bauteil viele
Merkmale. Einige davon sind Text, zum Beispiel das Material (PLA, ABS oder PETG)
oder die Oberflächengüte (grob, mittel oder fein). Andere sind Zahlen in sehr
unterschiedlichen Größenordnungen, zum Beispiel die Schichthöhe mit Werten unter
einem Millimeter und die Druckzeit mit Werten von mehreren hundert Minuten. Ein
ML-Modell kann mit Text nicht rechnen. Außerdem reagieren viele ML-Modelle
empfindlich, wenn die Zahlen so weit auseinanderliegen.

Bisher haben wir zur Prognose des Verkaufspreises eines Autos nur numerische
Merkmale wie den Kilometerstand genutzt. Heute nehmen wir zwei weitere Schritte
der Datenvorbereitung dazu. Zuerst übersetzen wir kategoriale Merkmale wie die
Farbe eines Autos in Zahlen. Diesen Schritt nennen wir **Kodierung**. Danach
bringen wir alle numerischen Merkmale in eine vergleichbare Größenordnung. Diesen
Schritt nennen wir **Skalierung**.
