...
Dabei ist der Funktionswert an der Stelle $x=0$ als $1$ gewählt. Es können aber
auch andere Werte gewählt werden. In dem Modul NumPy ist die Heaviside-Funktion
schon hinterlegt, siehe
