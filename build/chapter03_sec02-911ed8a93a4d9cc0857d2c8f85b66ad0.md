...
* [ ] Sie greifen mit **.loc[]** über das Label und mit **.iloc[]** über die Position auf einzelne Elemente und Teilbereiche zu und unterscheiden beide Zugriffsarten.
* [ ] Sie filtern eine Series mit **boolescher Indizierung**.
* [ ] Sie wenden **vektorisierte arithmetische Operationen** auf eine Series an, ohne Schleifen zu verwenden.
